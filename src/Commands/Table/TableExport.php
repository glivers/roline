 ...
 * table and generates formatted output files suitable for backups, data migration, or
 * analysis in external tools (Excel, database management tools, etc.).
 *
 ...
 *   2. Command validates table exists
 ...
 *
 * Examples:
 *   php roline table:export User
 *   - Exports to users_2025-01-15_143022.sql
 *
 *   php roline table:export Post posts_backup.sql
 *   - Exports as SQL to posts_backup.sql
 *
 *   php roline table:export Product products.csv
 *   - Exports as CSV to products.csv
 *
 * Usage:
 *   php roline table:export <Model> [filename]
 *
...
class TableExport extends TableCommand
{
    ...
    public function help()
    {
        ...
        Output::line('  php roline table:export User');
        Output::line('  php roline table:export Post posts_backup.sql');
        Output::line('  php roline table:export Product products.csv');
        Output::line();
    ...
    public function execute($arguments)
    {
        ...
        if (empty($arguments[0])) {
            ...
            $this->line();
            $this->info('Usage: php roline table:export <Model> [file]');
            $this->line();
            $this->info('Example: php roline table:export User');
            exit(1);
        }
